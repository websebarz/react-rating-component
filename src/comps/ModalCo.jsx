function ModalCo({
  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center">
      <div className=" w-5/6 sm:w-[380px] h-fit bg-gray-800 rounded-2xl sm:rounded-3xl">
        <div className="p-8">
          <div className="flex flex-col items-center justify-center p-4">
            ...
            <div className="flex align-center justify-center w-fit p-2 rounded-full bg-gray-700 w-4/5 mt-6">
              <p className="font-Overpass text-md text-orange-500">
                ...
                {fourStar === 4 && `You selected ${fourStar} out of 5`}
                {fiveStar === 5 && `You selected ${fiveStar} out of 5`}
              </p>
            </div>
            <h2 className="font-Overpass text-2xl text-white mt-6">
              Thank You!
            </h2>
          ...
          <div className="flex items-center justify-center mt-2">
            <button
              onClick={rateAgain}
              className="font-Overpass w-[100%] tracking-wider bg-orange-500 hover:bg-white rounded-full p-2 text-white hover:text-orange-500"
            >
              RATE AGAIN
            </button>
          </div>
